...
## Copyright (C) 2019-2025  Daniel A. Wagenaar
## 
...
The main functions to look at are: LOADIMAGE, SWIM, MIRAFFINE, AFFINEIMAGE,
AVERAGEIMAGE, AVERAGEIMAGENOBLACK, REMOD, SAVEIMAGE.
...
def shiftAffine(afm, dx):
    '''SHIFTAFFINE - Add a translation to an affine transform
...
def apodize(img, gray=None, inplace=False):
